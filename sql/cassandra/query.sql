...
CREATE FUNCTION GetAllProducts() RETURNS set<tuple<int, text, text, text, float>> LANGUAGE java AS 'return execute("SELECT id, name, manufacturer, description, price FROM product;").all();';
CALL GetAllProducts();
